...
class MainTab:
    ...
    def _setup_file_section(self):
        ...
        label = tk.Label(frame, text=self.app.language.get("main.label.font_file"))
    ...
    def _setup_encoding_section(self):
        ...
        label = tk.Label(frame, text=self.app.language.get("main.label.encoding"))
    ...
    def _setup_extras_section(self):
        ...
        label = tk.Label(frame, text=self.app.language.get("main.label.extras"))
    ...
    def _setup_action_section(self):
        ...
        self.app.btn_compress = styled_button(
            self.app,
            frame,
            self.app.language.get("main.button.compress_font"),
            lambda: events.compress_font(self.app),
            width=18
        )

        # Create status label
        status_text = self.app.language.get("main.status").format(
            self.app.language.get("main.status.idle")
        )
        ...
        self.app.ui_theme.set_theme_color(
