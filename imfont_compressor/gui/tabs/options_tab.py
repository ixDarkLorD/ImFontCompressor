...
class OptionsTab:
    ...
    def _setup_language_and_theme_section(self):
        ...
        row_frame = tk.Frame(self.frame, bd=2, relief="raised")
        row_frame.pack(padx=self.app.pad_x, pady=self.app.pad_y + 4, anchor="center")
        self.app.ui_theme.set_theme_color(row_frame, 
            bg=ColorKeys.BG_CHILD_FRAME
        )

        # === Language Section ===
        lang_frame = tk.Frame(row_frame, bd=2, relief="sunken")
        lang_frame.pack(side="left", padx=(self.app.pad_x, 5), pady=self.app.pad_y)
        ...
        lang_label.pack(side="left", pady=2)
        ...
        self.app.language_combo.pack(side="left", pady=2)
        ...
        theme_frame.pack(side="left", padx=(5, self.app.pad_x), pady=5)
        ...
        theme_label.pack(side="left", pady=2)
        ...
        self.app.theme_combo.pack(side="left", pady=2)
